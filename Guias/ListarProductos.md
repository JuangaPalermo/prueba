<h1 align="center">POST Factura/ListarProductos</h1>

Permite obtener los productos de Tango factura.

<h2 align="center">URL del Resource</h2>

https://www.tangofactura.com/Factura/ListarProductos
...
<tr>
    <td>Filtro</td>
    <td>Obtiene o Setea el filtro</td>
    <td>String</td>
    <td>si</td>
    <td>-</td>
</tr>
<tr>
    <td>ConCodigo</td>
    <td>Obtiene o Setea el parametro</td>
    <td>Boolean</td>
    <td>Si</td>
    <td>-</td>
</tr>
...
```
    {
        "Data": {
            "ProductoPrecioFinal": 0.0,
            "ProductoPrecioFinalCompra": 0.0,
            "ProductoPublicado": false,
